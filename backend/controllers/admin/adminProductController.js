...
export const addProduct = async (req, res) => {
    try {
        ...
        const { categoryId, productName, productDescription, productDetails, price, unitType, piecesPerBox, isBestSeller, isActive, isOutOfStock, hasVariant, hasVariantCombination, hasExpirationDate, variantNames, variantValues, variantCombination} = req.body;

        const result = await addProductService( ID, categoryId, productName, productDescription, productDetails, price, unitType, piecesPerBox, image1, image2, image3, image4, isBestSeller, isActive, isOutOfStock, hasVariant, hasVariantCombination, hasExpirationDate, variantNames, variantValues, variantCombination);
...
export const updateProduct = async (req, res) => {
    try {
        ...
        const {productID, categoryId, productName, productDescription, productDetails, price, unitType, piecesPerBox, isBestSeller, isActive, isOutOfStock, hasVariant, hasVariantCombination, hasExpirationDate, variantNames, variantValues, variantCombination, image1, image2, image3, image4} = req.body;

        const result = await updateProductService(ID, productID, categoryId, productName, productDescription, productDetails, price, unitType, piecesPerBox, image1File, image2File, image3File, image4File, image1, image2, image3, image4, isBestSeller, isActive, isOutOfStock, hasVariant, hasVariantCombination, hasExpirationDate, variantNames, variantValues, variantCombination);
