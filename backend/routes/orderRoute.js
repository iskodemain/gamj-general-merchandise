...
// EDIT ORDER PAYMENT PROOF
orderRouter.put('/payment-proof/edit', customerAuth, upload.single('receiptImage'), editOrderPaymentProof);
...
orderRouter.get('/order-delivery-proof', customerAuth, fetchOrderDeliveryProof);
