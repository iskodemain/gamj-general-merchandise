                ...
                <div className="right-col">
                  ...
                  <div className="order-info">
                    ...
                    <div className="info-row">
                      ...
                      <span className="value">{order.status === "Delivered" ? "Paid" : order.status}</span>
                    </div>
                  ...
                  {/* anchor trash separately so it won't move when View All changes */}
                  <button
                    className="trash-btn trash-abs"
                    type="button"
                    aria-label={`Delete order ${order.id}`}
                    onClick={() => {
                      if (window.confirm(`Delete order #${order.id}?`)) {
                        // TODO: implement actual delete logic (API / state update)
