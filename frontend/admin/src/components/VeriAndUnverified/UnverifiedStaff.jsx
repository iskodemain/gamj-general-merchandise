...
import './UnverifiedStaff.css';
import UnverifiedStaffView from './UnverifiedStaffView';
import Navbar from '../Navbar';

 function UnverifiedStaff() {
  ...
  return (
    <>
    <Navbar TitleName="Unverified Staff"/>
