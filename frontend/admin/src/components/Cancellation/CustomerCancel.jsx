...
`Nagdagdag ng admin note: produkto ay na-substitute, kaya nag-request ng full refund. Sundin ang refund policy at i-log ang action.`
    ...
    return(
        <div className='adminCancel'>
            ...
            {/* NEW: simple form/info box placed ABOVE the reason textarea */}
            

            <div className="adminReasonSection">
                <div className="sectionLabel">Reason for Cancellation</div>
                 <div className="additionalBox">
                    <div className="boxText">Wrong Item Ordered</div>
                 </div>
                <textarea
